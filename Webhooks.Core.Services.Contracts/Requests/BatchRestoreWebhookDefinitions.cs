...
namespace Webhooks.Core.Services.Contracts.Requests
{
    ...
    public abstract class BatchRestoreWebhookDefinitionsBase : IPost, IReturn<List<WebhookDefinitionResponse>>
    {
        ...
        /// <summary>
        /// The password to authenticate the author and authorize the restore operation.
        /// </summary>
        [ApiMember(Description = "The password to authenticate the author and authorize the restore operation.", IsRequired = true)]
